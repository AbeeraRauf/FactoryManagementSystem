...
my_path='stock_in_out_record.pdf'
...
def generate_stock_record(df):
    
    ##############################################################################################################
    my_doc=SimpleDocTemplate(my_path,pagesize=A4)
    c_width=[1*inch,1.5*inch,1.5*inch,1*inch,1.5*inch]
    ...
    title_style.alignment = 1
    stockdets = Paragraph("Stock IN and OUT Details", title_style)
